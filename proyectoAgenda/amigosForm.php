...
<html>
   <head>
      <meta charset="UTF-8">
      <title>Formulario Entrada Teléfonos Agenda</title>
   </head>
   <body>
      <?php
      
         function formulario($campos,$action,$method="post",$enctype="multipart/form-data") {
         ...
         formulario($campos,"amigosFormInserta.php");
      ?>
      <!--      
